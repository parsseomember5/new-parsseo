...
@section('content')
    <div class="d-flex align-items-center justify-content-between mb-4">
        <h4 class="py-3 breadcrumb-wrapper m-0 pb-0">
            <span class="text-muted fw-light">تنظیمات /</span> لندینگ طراحی سایت
        </h4>
        @include('admin.includes.lang_switcher')
    </div>
    @include('admin.views.settings.nav')
    @include('admin.includes.alerts')
    <form action="{{route('settings.webdesign_update',$settings)}}" method="post" enctype="multipart/form-data">
        @csrf
        <div class="row">
        <div class="col-lg-8">
            <div class="card">
