                    ...
                    <div class="d-flex flex-wrap gap-4 mb-5 mt-4">
                        ...
                        <div class="d-flex flex-column me-2">
                            ...
                            <ul class="list-unstyled me-2 d-flex align-items-center avatar-group mb-0">
                                ...
                                <li data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top" title="پیتر پارکر" class="avatar avatar-xs pull-up">
                                    <img class="rounded-circle" src="{{asset('admin/assets/img/avatars/9.png')}}" alt="Avatar">
                                </li>
                                <li data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top" title="استیو جابز" class="avatar avatar-xs pull-up">
                                    <img class="rounded-circle" src="{{asset('admin/assets/img/avatars/15.png')}}" alt="Avatar">
                                </li>
                                ...
                                <li data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top" title="بیل گیتس" class="avatar avatar-xs pull-up">
                        ...
                        <li class="timeline-item timeline-item-transparent ps-4">
                            ...
                            <div class="timeline-event pb-2">
                                <div class="timeline-header mb-1">
                                    ...
                                    <small class="text-muted">12 دقیقه قبل</small>
                                </div>
                        ...
                        <li class="timeline-item timeline-item-transparent ps-4">
                            ...
                            <div class="timeline-event pb-2">
                                <div class="timeline-header mb-1">
                                    ...
                                    <small class="text-muted">45 دقیقه قبل</small>
                                </div>
                                ...
                                <div class="d-flex flex-wrap">
                                    ...
                                    <div>
                                        <h6 class="mb-0">بیل گیتس (مشتری)</h6>
                            ...
                            <div class="timeline-event pb-0">
                                ...
                                <div class="d-flex align-items-center avatar-group">
                                    ...
                                    <div class="avatar avatar-sm pull-up" data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top" title="Kristine Gill">
                                        <img src="{{asset('admin/assets/img/avatars/16.png')}}" alt="Avatar" class="rounded-circle">
                                    </div>
