    ...
    <div class="card">
        <div class="card-header d-flex flex">
            ...
            <div class="ms-auto text-end primary-font pt-3 pt-md-0">
                <a href="{{route('users.trash')}}" class="btn btn-label-secondary"><span><i class="bx bx-trash me-sm-2"></i> <span class="d-none d-sm-inline-block">زباله‌دان</span></span></a>
                <a href="{{route('users.create')}}" class="btn btn-primary"><span><i class="bx bx-plus me-sm-2"></i> <span class="d-none d-sm-inline-block">افزودن رکورد جدید</span></span></a>
            </div>
        </div>
                        ...
                        <td>
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu">
                                   {{--
                                   <a class="dropdown-item" href="{{route('users.cart',$user)}}"><i class="bx bx-show-alt me-1"></i> سبد خرید</a>
                                   --}}
                                    <a class="dropdown-item" href="{{route('users.wallet',$user)}}"><i class="bx bx-show-alt me-1"></i> کیف پول</a>

                                    <a class="dropdown-item" href="{{route('users.edit',$user)}}"><i class="bx bx-edit-alt me-1"></i> ویرایش</a>
